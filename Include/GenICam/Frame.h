...
public:	
	...
	/// \return 返回图片时间戳
	/// \~english
	/// \brief get timestamp of image(GigE/Usb/PCIe Camera Only)
	...
	/// \~english
	/// \brief get the block ID of image(GigE/Usb/PCIe Camera Only)
	...
	/// \return 是否成功
	/// \~english
	/// \brief get chunk data(GigE/Usb Camera Only)
    ...
    /// \return 返回图片paddingX
    /// \~english
    /// \brief get image paddingX(GigE/Usb/PCIe Camera Only)
    /// \return paddingX	
    ...
    /// \return 返回图片paddingY
    /// \~english
    /// \brief get image paddingY(GigE/Usb/PCIe Camera Only)
    /// \return paddingY		
