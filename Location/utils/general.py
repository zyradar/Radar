...
from Location.utils import TryExcept, emojis
from Location.utils.downloads import curl_download, gsutil_getsize
from Location.utils.metrics import box_iou, fitness
...
def check_amp(model):
    ...
    from Location.models.common import AutoShape, DetectMultiBackend
